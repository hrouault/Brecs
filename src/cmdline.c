...
const char *gengetopt_args_info_purpose = "Reconstruct superresolution images";
...
void clear_args (struct gengetopt_args_info *args_info)
{
  ...
  args_info->psf_arg = NULL;
  args_info->psf_orig = NULL;
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->psf_help = gengetopt_args_info_help[3] ;
...
cmdline_parser_release (struct gengetopt_args_info *args_info)
{
  ...
  free_string_field (&(args_info->psf_arg));
  free_string_field (&(args_info->psf_orig));
...
cmdline_parser_dump(FILE *outfile, struct gengetopt_args_info *args_info)
{
  ...
  if (args_info->psf_given)
    write_into_file(outfile, "psf", args_info->psf_orig, 0);
...
cmdline_parser_required2 (struct gengetopt_args_info *args_info, const char *prog_name, const char *additional_error)
{
  ...
  if (! args_info->conf_given)
    {
      fprintf (stderr, "%s: '--conf' ('-c') option required%s\n", prog_name, (additional_error ? additional_error : ""));
      error_occurred = 1;
    }
